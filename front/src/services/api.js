...
export const getArticlesWithJournalists = async (journalistId) => {
  const response = await axios.get(`${API_BASE_URL}/journalists/${journalistId}/articles`);
  return response.data;
};

export const getallArticlesWithJournalists = async () => {
  const response = await axios.get(`${API_BASE_URL}/journalists/articles`);
  return response.data;
};

export const gerArticlesWithCategory = async (id) => {
  const response = await axios.get(`${API_BASE_URL}/category/${id}/articles`);
  return response.data;
};
